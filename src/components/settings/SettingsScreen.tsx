      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <button
              onClick={logout}
              className="w-full bg-white dark:bg-gray-800 text-red-500 py-3 rounded-lg font-medium flex items-center justify-center hover:bg-gray-50 dark:hover:bg-gray-700"
            >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
              ...
              <div className="p-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    {theme === "dark" ? (
                      <MoonIcon size={20} className="text-[#1E88E5] mr-3" />
                    ) : (
                      <SunIcon size={20} className="text-[#1E88E5] mr-3" />
                    )}
              ...
              <div className="p-4 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      checked={user?.preferences.taskReminders || false}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      checked={user?.preferences.dailySummary || false}
                      onChange={handleToggleDailySummary}
                      className="sr-only peer"
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-[#1E88E5]"></div>
                  </label>
